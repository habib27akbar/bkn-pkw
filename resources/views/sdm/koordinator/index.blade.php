          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               <a href="{{ route('koordinator.create') }}" class="btn btn-primary">Tambah</a>
                <br/><br/>
                  ...
                  <tbody>
                      @foreach($sdm as $key => $value)
                          <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <form method="POST" action="{{ route('koordinator.destroy', ['koordinator' => $value->id]) }}">
                                        <a href="{{ route('koordinator.edit', $value->id) }}" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                        @method('DELETE')
                                        @csrf
