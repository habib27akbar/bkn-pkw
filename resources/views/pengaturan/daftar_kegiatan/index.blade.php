                          ...
                          <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="{{ route('kegiatan.edit', $value->id) }}" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                    <form method="POST" action="{{ route('kegiatan.destroy', ['kegiatan' => $value->id]) }}">
                                        @method('DELETE')
                                        @csrf
