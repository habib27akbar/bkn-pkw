            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000">
                    <div class="img-holder">
                        <img src="{{ asset('img/event/'.$value['gambar']) }}" alt="" srcset="">
                    </div>
                    <div class="text-holder">
                        <div class="meta-info">
                            <p><span class="icon-calendar"></span> {{ $value['tanggal'] }}</p>
                        </div>
                        <h3><a href="{{ route('event_bkn.edit',$value['id']) }}">{{ $value['judul'] }}</a></h3>
                        <p><?=substr($value['isi'], 0,400)?></p>
                        <div class="btn-box">
                            <a href="{{ route('event_bkn.edit',$value['id']) }}">selanjutnya</a>
                        </div>
                    </div>
                </div>
            </div>
