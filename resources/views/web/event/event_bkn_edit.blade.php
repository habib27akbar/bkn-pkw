                        ...
                        <div class="blog-details-content">
                            ...
                            <div class="single-blog-style1 single-blog-style1--instyle3">
                                <div class="img-holder">
                                    <img src="{{ asset('img/event/'.$event['gambar']) }}" alt="">
                                    <div class="date-box">
                                        <h6>{{ TanggalHelper::get_tanggal($event['tanggal']) }}</h6>
                                    </div>
                                </div>
                                <div class="text-holder">
                                    ...
                                    <div class="text-inner">
                                        <h5 class="blog-title" style="font-size: 23px">{{ $event['judul'] }}</h5>
                                    </div>
                                    <div class="text">
                                        <?=$event['isi']?>
                                    </div>
                            ...
                            <div class="single-sidebar-box" style="margin-top:0px">
                                ...
                                <ul class="sidebar-categories-box">
                                    @foreach($event_all as $key => $value)
                                        <li>
                                            <a href="{{ route('event_bkn.edit',$value['id']) }}">
                                                {{ $value['judul'] }}
                                            </a>
                                        </li>
                                    @endforeach
