  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Kesiapan Lokasi</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Kesiapan Lokasi</a></li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary"> 
                <form action="{{ route('kesiapan-lokasi.update', ['kesiapan_lokasi' => $lokasi[0]['id']]) }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group row">
                            <label for="file" class="col-sm-2 col-form-label">Kesiapan Lokasi</label>
                            <div class="col-sm-10">
                               <input type="text" name="kesiapan_lokasi" class="form-control" value="{{ $lokasi[0]['kesiapan_lokasi'] }}">
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('kesiapan-lokasi.index') }}" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
          </div>
