        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary"> 
                <form action="{{ route('setup_sdm_koordinator.store') }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        
                        <div class="form-group row">
                            <label for="file" class="col-sm-2 col-form-label">Koordinator</label>
                            <div class="col-sm-5">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('setup_sdm_koordinator.index') }}" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
          </div>
