        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary"> 
                <form action="{{ route('installasi_barang.update', ['installasi_barang' => $pelaporan_kegiatan['id']]) }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('installasi_barang.index') }}" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
          </div>
