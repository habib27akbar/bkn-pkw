        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary"> 
                <form action="{{ route('penutupan.update', ['penutupan' => $pelaporan_kegiatan['id']]) }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('penutupan.index') }}" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
          </div>
