...
class PenutupanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pelaporan_kegiatan.penutupan.create', compact('menu', 'barang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pelaporan_kegiatan.penutupan.edit', compact('menu', 'barang', 'pelaporan_kegiatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('penutupan')->with('alert-success', 'Success Tambah Data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('penutupan')->with('alert-success', 'Success Update Data');
    }

    public function destroy($id)
    {
        PelaporanKegiatan::findOrFail($id)->delete();
        return redirect('penutupan')->with('alert-success', 'Success deleted data');
    }
}
