...
class UjiFungsiController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pelaporan_kegiatan.uji_fungsi.create', compact('menu', 'barang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pelaporan_kegiatan.uji_fungsi.edit', compact('menu', 'barang', 'pelaporan_kegiatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('uji_fungsi')->with('alert-success', 'Success Tambah Data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('uji_fungsi')->with('alert-success', 'Success Update Data');
    }

    public function destroy($id)
    {
        PelaporanKegiatan::findOrFail($id)->delete();
        return redirect('uji_fungsi')->with('alert-success', 'Success deleted data');
    }
}
