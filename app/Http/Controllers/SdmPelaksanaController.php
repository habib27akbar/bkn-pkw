...
class SdmPelaksanaController extends Controller
{
    public function index()
    {
        ...
        return view('laporan.sdm_pelaksana.index', compact('menu', 'lokasi'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('laporan.sdm_pelaksana.edit', compact('menu', 'lokasi', 'provinsi', 'kabupaten_kota', 'sdm'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('sdm-pelaksana')->with('alert-success', 'Success Update Data');
    }
}
